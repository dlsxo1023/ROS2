    ...
    try:   
        while rclpy.ok():
            ...
            if node.nav_msg.data == "point1":
                ...
                rgoal.pose.position.x = 2.71
                rgoal.pose.position.y = 0.921
                ...
                rgoal.header.stamp.nanosec = 0
                rgoal.pose.position.z = 0.0
                rgoal.pose.position.x = 2.57
                rgoal.pose.position.y = -0.765
                rgoal.pose.orientation.w = 1.0
                ...
                rgoal.header.stamp.nanosec = 0
                rgoal.pose.position.z = 0.0
                rgoal.pose.position.x = 1.22
                rgoal.pose.position.y = -0.776
                rgoal.pose.orientation.w = 1.0
                ...
                rgoal.header.stamp.nanosec = 0
                rgoal.pose.position.z = 0.0
                rgoal.pose.position.x = 0.357
                rgoal.pose.position.y = 1.33
                rgoal.pose.orientation.w = 1.0
            else:
                pass
            print(rgoal)
